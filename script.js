...
function loadDisclaimer() {
    document.getElementById('popupTitle').textContent = "DISCLAIMER";
    const popupBody = document.getElementById('popupBody');
    popupBody.innerHTML = `
        <div class="DISCLAIMER">
            <p>
                This ad-free <strong>gn-math</strong> html file/link
                <strong>IS NOT OFFICIAL AND IS NOT AUTHORIZED OR ENDORSED BY GN MATH</strong>
            </p>
            <ol>
                <p>
                    For official links <a href="https://discord.gg/D4c9VFYWyU" target="_blank" rel="noopener noreferrer">
                        join the GN Math Discord server
                    </a> or use the /gen-link command from the gn math bot in select servers or something
                </p>
                <p>
                    For more modded GN math links, visit 
                    <a href="https://discord.gg/qE6jbD3uUv">the DAsprunk Discord server</a> where fantasy and fun come to life
                </p>
            </ol>
            <p>
                breadbb, if you are reading this, these unofficial modded links/html files are not meant to kill the site, these things are meant for people who want a better GN Math expirience
            </p>
        </div>
    `;
    popupBody.contentEditable = false;
